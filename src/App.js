            ...
            <nav className={style.navbar} >
                ...
                <div className={style.navbarRight} >
                      ...
                      <form action="/i18n/setlang/" method="post" id="myForm">
                        ...
                        <span >
                          <select name="language" id onchange="submitForm();" style={{color: 'white', background: '#212121',marginTop:'40px'}}>
                            <option value="hy">
                              հայերեն
                              (hy)
                            </option>
                ...
                {/* Collapsible content */}
                    ...
                    <form>
                      <div className style={{margin: 0}}>
                        <input name="q" type="text" placeholder="Search..." style={{margin: '0px', padding: '6px', width: '10rem', outline: 'none'}} />
                        <IconButton>
